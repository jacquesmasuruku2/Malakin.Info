...
const translations: Record<SupportedLocale, typeof frMessages> = {
  ...
  en: createMessages({
    ...
    footer: {
      ...
      madeWith: 'Made Africa',
      inTheNews: 'IN THE NEWS',
      africanNews2026: 'African News 2026',
      aboutMalakin: 'ABOUT MALAKINFO',
      whoAreWe: 'Who are we?',
      ourMission: 'Our Mission',
      ourTeam: 'Our Team',
      advertising: 'Advertising',
      malakinMediaNetwork: 'MALAKINFO NETWORK',
      malakinRadioAfrica: 'MalakInfo Radio',
      focusEco: 'Media',
      youthTribune: 'Live',
      malakinDocu: 'Photos',
    ...
    nav: {
      ...
      servicesMalakin: 'MalakInfo Services',
      search: 'Search',
      archives: 'Archives',
