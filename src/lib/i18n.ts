...
const translations: Record<SupportedLocale, typeof frMessages> = {
  ...
  en: createMessages({
    ...
    home: {
      ...
      latestFeed: 'Latest News',
      stayInformed: 'Stay informed',
      newsletterSubtitle: 'Subscribe to our newsletter to receive the latest news.',
      subscribe: 'Subscribe',
      noArticlesInCategory: 'No articles available for this category yet.',
      watchNow: 'Watch now',
      live: 'LIVE',
      onAir: 'on air',
    },
  ...
  es: createMessages({
    ...
    home: {
      ...
      latestFeed: 'Últimas noticias',
      stayInformed: 'Mantente informado',
      newsletterSubtitle: 'Suscríbete a nuestro boletín para recibir las últimas noticias.',
  ...
  sw: createMessages({
    ...
    home: {
      ...
      categories: 'Aina',
      latestFeed: 'Habari mpya',
      stayInformed: 'Pata habari',
      newsletterSubtitle: 'Jiandikishe kupokea habari mpya.',
      subscribe: 'Jiandikishe',
      noArticlesInCategory: 'Bado hakuna makala katika sehemu hii.',
  ...
  ln: createMessages({
    ...
    home: {
      ...
      categories: 'Bikotisa',
      latestFeed: 'Makambo ya sika',
      stayInformed: 'Zwa sango',
      newsletterSubtitle: 'Kota na newsletter mpo na kozwa sango ya sika.',
      subscribe: 'Kota',
      noArticlesInCategory: 'Article ezali naino te na eteni oyo.',
      watchNow: 'Tala sikoyo',
      live: 'NA DIRECT',
      onAir: 'na direct',
    },
    nav: {
  ...
  rw: createMessages({
    ...
    home: {
      ...
      categories: 'Ibyiciro',
      latestFeed: 'Amakuru mashya',
      stayInformed: 'Menya amakuru',
      newsletterSubtitle: 'Iyandikishe kugira ngo wakire amakuru mashya.',
      subscribe: 'Iyandikishe',
      noArticlesInCategory: 'Nta nkuru zirimo muri iki cyiciro.',
      watchNow: 'Reba none',
      live: 'LIVE',
      onAir: 'kuri live',
    },
