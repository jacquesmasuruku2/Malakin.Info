...
export default function ShareButtons({ title, url, locale }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-2 sm:gap-4 mb-6 sm:mb-8 pb-6 sm:pb-8 border-b border-border flex-wrap">
      ...
      <button
        ...
        className="p-1.5 sm:p-2 text-muted-foreground hover:text-black transition-colors"
        title="Twitter / X"
      >
        <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      <button
        ...
        className="p-1.5 sm:p-2 text-muted-foreground hover:text-blue-700 transition-colors"
        title="LinkedIn"
      >
        <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      <button
        ...
        className="p-1.5 sm:p-2 text-muted-foreground hover:text-green-600 transition-colors"
        title="WhatsApp"
      >
        <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="currentColor">
