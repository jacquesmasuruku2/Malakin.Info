...
import { Mail, Phone, MapPin, Building, Users, Heart, Send, CheckCircle, Handshake } from 'lucide-react';

export default function PartenariatsSoutenirPage() {
  ...
  const partnershipTypes = [
    {
      ...
      description: 'Sponsoring, publicité et placements de marque pour soutenir notre mission.',
      color: 'bg-primary',
    },
    {
      icon: Users,
      title: 'Partenariat Média',
      description: 'Échanges de contenu, diffusion croisée et co-production de reportages.',
      color: 'bg-accent',
    },
    {
      icon: Heart,
      title: 'Partenariat Institutionnel',
      description: 'Collaborations avec fondations, ONG et organisations internationales.',
      color: 'bg-secondary',
    },
    {
      icon: Handshake,
      title: 'Partenariat Communautaire',
      description: 'Collaborations avec associations locales et initiatives communautaires.',
      color: 'bg-primary',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            ...
            <div className="mt-12 bg-gradient-to-br from-accent/10 to-primary/10 rounded-xl p-8">
              <h3 className="font-heading text-2xl font-bold mb-4">Avantages pour nos partenaires</h3>
              <ul className="space-y-3">
                {[
                  'Visibilité auprès de 2 millions de visiteurs mensuels',
                  'Association avec une marque de confiance',
                  'Accès à un public engagé et qualifié',
                  'Impact positif sur le journalisme africain',
                  'Opportunités de co-création de contenu',
                  'Rapports d\'impact et métriques détaillés',
                ].map((benefit, index) => (
          ...
          <div>
            ...
            {isSubmitted ? (
              <div className="bg-card rounded-xl p-8 text-center border-2 border-green-500">
                ...
                <p className="text-muted-foreground">
                  Notre équipe de partenariats vous contactera dans les plus brefs délais.
                </p>
              </div>
            ) : (
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="community">Partenariat Communautaire</option>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Décrivez votre projet de partenariat et comment vous souhaitez nous soutenir..."
                    />
                  </div>
            ...
            <div className="mt-8 bg-gradient-to-r from-accent/10 to-primary/10 rounded-xl p-6">
              <h3 className="font-heading text-lg font-semibold mb-3 flex items-center gap-2">
                <Heart className="w-5 h-5 text-primary" />
                Vous préférez faire un don ?
              </h3>
