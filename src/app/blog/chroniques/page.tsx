...
export default function ChroniquesPage() {
  const articles = [
    ...
    },
    {
      ...
      title: 'Chronique sportive : Le football comme vecteur d\'unité',
      excerpt: 'Le rôle du sport dans la cohésion sociale et le développement communautaire.',
      date: '25 Juin 2026',
      readTime: '5 min',
    },
  ];
          ...
          {articles.map((article) => (
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-sm font-medium text-accent">Par {article.author}</span>
              </div>
              ...
              <Link
                href={`/blog/chroniques/${article.id}`}
