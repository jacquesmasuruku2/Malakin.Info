...
export default function SecuritePage() {
  const news = [
    ...
    {
      id: 2,
      title: 'Renforcement des forces de police : Nouvelle formation',
      excerpt: 'Le ministère de l\'intérieur lance un programme de formation moderne pour les forces de l\'ordre.',
      image: 'https://images.unsplash.com/photo-1541499652-10279ba4f5e6?w=800&h=400&fit=crop',
      date: '24 Juin 2026',
      readTime: '4 min',
    },
  ];
    ...
    <div className="flex flex-col">
      <section className="bg-gradient-to-r from-secondary to-secondary/80 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-heading text-4xl font-bold mb-4">Sécurité</h1>
          ...
          {news.map((item) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link
                  href={`/actualites/securite/${item.id}`}
