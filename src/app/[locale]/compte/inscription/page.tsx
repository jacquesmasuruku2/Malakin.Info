      ...
      <div className="mx-auto max-w-md rounded-sm bg-white p-6 shadow-sm md:p-8">
        ...
        <div className="mx-auto max-w-sm">
          <div className="mb-4 text-left">
            <h2 className="text-lg font-bold text-gray-900">Créer un compte avec un mot de passe</h2>
          </div>

          <div className="mb-4 space-y-2 text-left text-sm text-gray-700">
            <p>
              Vous avez déjà un compte ? <a href="/fr/compte/connexion" className="font-medium text-primary underline hover:text-primary/80">Connectez-vous.</a>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2 text-left">
              ...
              <label htmlFor="terms" className="text-xs text-gray-700">
                J'accepte les{' '}
                <Link href="/conditions-utilisation" className="font-medium text-primary underline hover:text-primary/80">
                  conditions d'utilisation
                </Link>{' '}
                et la{' '}
                <Link href="/politique-confidentialite" className="font-medium text-primary underline hover:text-primary/80">
