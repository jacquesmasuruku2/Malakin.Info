...
import { Calendar, ArrowRight, BarChart3, User, Clock } from 'lucide-react';
import { prisma } from '@/lib/prisma';

export const dynamic = 'force-dynamic';

export default async function SondagesPage({ params }: { params: Promise<{ locale: string }> }) {
        ...
        <div className="space-y-6">
          {articles.map((article) => (
            ...
            >
              ...
              <Link
                href={`/${locale}/blog/sondages/${article.slug}`}
