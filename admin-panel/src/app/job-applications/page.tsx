  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Candidatures d'emploi</h1>
          <p className="text-gray-600 mt-1">Gérez les candidatures soumises aux offres d'emploi</p>
        </div>
