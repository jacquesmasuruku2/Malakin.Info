...
export default function NewMediaPage() {
  ...
  const [form, setForm] = useState({ title: '', slug: '', description: '', url: '', thumbnailUrl: '', duration: '', publishedAt: '', featured: false });
